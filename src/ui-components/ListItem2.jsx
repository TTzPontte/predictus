...
import Rectangle153 from "./Rectangle153";
  ...
  return (
    ...
    >
      <Flex
        ...
        {...getOverrideProps(overrides, "ItemCheckBox")}
      >
        <Flex
          gap="16px"
          direction="row"
          ...
          >
            ...
            >
              <Icon
                ...
                left="0%"
                right="0%"
                {...getOverrideProps(overrides, "Vector37522755")}
              ></Icon>
            </View>
            <View
              width="2px"
            ...
            >
              <Icon
                ...
                left="0%"
                right="0%"
                {...getOverrideProps(overrides, "Vector37522757")}
              ></Icon>
            </View>
          </Flex>
          <Rectangle153
      ...
      <Flex
        ...
        {...getOverrideProps(overrides, "data37522759")}
      >
        <Text
      ...
      <Flex
        ...
        position="relative"
        padding="16px 0px 16px 0px"
        {...getOverrideProps(overrides, "data37522761")}
      >
        <Flex
          gap="10px"
          direction="row"
          ...
          {...getOverrideProps(overrides, "Exhibit")}
        >
          <Text
            fontFamily="Montserrat"
            fontSize="12px"
      ...
      <Flex
        ...
        position="relative"
        padding="16px 0px 16px 0px"
        {...getOverrideProps(overrides, "data37522764")}
      >
        <Text
          fontFamily="Montserrat"
          fontSize="14px"
      ...
      <Flex
        ...
        position="relative"
        padding="16px 0px 16px 0px"
        {...getOverrideProps(overrides, "data37522766")}
      >
        <Text
          fontFamily="Montserrat"
          fontSize="14px"
      ...
      <Flex
        ...
        {...getOverrideProps(overrides, "data37522768")}
      >
        <Text
          fontFamily="Montserrat"
          fontSize="14px"
