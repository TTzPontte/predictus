...
function ReportForm() {
  ...
  return (
    <FormProvider {...methods}>
      <Form className="add-entity-form" onSubmit={handleSubmit(onSubmit)}>
      ...
      <br></br>
      {isResultView2Visible ? <button onClick={handleBaixarPDF}>Baixar Relatório PDF</button> : null}
      <br></br>
      <br></br>
      <br></br>
      {isResultView2Visible ? <ResultView2 {...{ state2, setState2 }} /> : null}
      <br></br>
      {isResultView2Visible ? <button onClick={handleConsultarSocios}>Consultar Sócios</button> : null}
      <br></br>
      <br></br>
    </FormProvider>
  );
